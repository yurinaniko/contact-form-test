...
管理ユーザーのシーダーは用意していないため、まず新規登録してください
（本アプリの要件では「ログインできるユーザー＝管理者」です。冒頭の注意書き参照）。

1. 新規登録：http://localhost:8003/register で任意のユーザーを登録
2. ログイン：http://localhost:8003/login からログイン
3. 登録・ログイン後、管理画面 http://localhost:8003/admin が表示されます
## 使用技術
```
- Laravel 12.x
- PHP 8.3
